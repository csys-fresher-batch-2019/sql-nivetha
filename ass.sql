...
insert into daily_work(status_check,work_name,work_by,deadline_date,completed_date)
values('completed','installation','sound',to_date('28-12-2019','dd-MM-yyyy'),to_date('27-12-2019','dd-MM-yyyy')                                                                                    
...
insert into daily_work(status_check,work_name,work_by,deadline_date,completed_date,priority)
values('completed','installation','nandhu',to_date('27-12-2019','dd-MM-yyyy'),to_date('26-12-2019','dd-MM-yyyy',2)                                                                                     
